...
def run_experiment(config):
    ...
    if config['file_output']:
        plt.savefig(config['file_name_prefix'] + config['network'] + '_experiment_acc_rate_with_error_bar' + str(time.time()) + '.pdf')
    plt.show()
    ...
    plt.legend()
    if config['file_output']:
        plt.savefig(config['file_name_prefix'] + config['network'] + '_experiment_ext_time_with_error_bar' + str(time.time()) + '.pdf')
    plt.show()
    ...
    plt.legend()
    if config['file_output']:
        plt.savefig(config['file_name_prefix'] + config['network'] + '_experiment_acc_rate' + str(time.time()) + '.pdf')
    plt.show()
    ...
    plt.legend()
    if config['file_output']:
        plt.savefig(config['file_name_prefix'] + config['network'] + '_experiment_ext_time' + str(time.time()) + '.pdf')
    plt.show()
